...
export function IsometricFlowCanvasViewportHud({ viewRect, onResetView }: IsometricFlowCanvasViewportHudProps) {
  return (
    <div className="pointer-events-none absolute bottom-2 right-2 z-10 flex max-w-[min(100%,260px)] flex-col items-end gap-1">
      ...
      <p className="hidden text-right text-[10px] leading-snug text-stone-500 dark:text-stone-400 sm:block">
        Vacío: arrastrar rectángulo de selección · Mayús/Cmd/Ctrl: añadir a la selección o varios bloques · Rueda: zoom ·
        Centro o Alt+arrastrar: mover la vista
      </p>
    </div>
  );
}
