...
import { Home, Maximize2, PanelLeftOpen, ChevronLeft, ChevronRight, StickyNote } from "lucide-react";
...
export function PublicViewShell({ deck }: { deck: PulledPresentation }) {
  ...
  }, [goNextSlide, goPrevSlide, isPreviewOpen]);
      ...
      <div className="flex min-h-0 min-w-0 flex-1">
        ...
        <div className="flex flex-1 min-w-0 min-h-0 flex-col">
          <header className="flex h-9 shrink-0 items-stretch border-b border-stone-200/90 bg-white dark:border-border dark:bg-surface-elevated">
            <div className="flex min-w-0 flex-1 items-center border-r border-stone-200/90 bg-stone-50/40 px-3.5 dark:border-border dark:bg-background/40 sm:px-4">
          ...
          <div className="flex min-h-0 min-w-0 flex-1">
            ...
            <section
              ...
              aria-label="Lienzo de diapositiva (solo consulta)"
            >
              ...
              >
                <div className="flex flex-wrap items-center justify-center gap-3">
                  <div className={floatingBarClass} role="toolbar" aria-label="Cambiar diapositiva">
                    <button
                      type="button"
                      onClick={goPrevSlide}
                      disabled={index === 0}
